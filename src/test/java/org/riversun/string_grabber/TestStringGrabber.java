...
public class TestStringGrabber {
	...
	@Test
	public void test_removeHeadConsecutiveChars() throws Exception {
		StringGrabber sg = new StringGrabber("   abc   ");
		assertEquals("abc   ", sg.removeHeadConsecutiveChars(' ').toString());

	}

	@Test
	public void test_removeTailConsecutiveChars() throws Exception {
		StringGrabber sg = new StringGrabber("   abc   ");
		assertEquals("   abc", sg.removeTailConsecutiveChars(' ').toString());

	}

	@Test
	public void test_removeHeadAndTailChars() throws Exception {
		StringGrabber sg = new StringGrabber("   abc   ");
		assertEquals("abc", sg.removeHeadAndTailChars(' ').toString());
